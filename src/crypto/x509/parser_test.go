...
func TestUnsortedSETInRDN(t *testing.T) {
	...
	// The issue was reported in https://github.com/golang/go/issues/73743
	...
	// Before our fix, this would have parsed successfully
	// With our fix, it should fail due to unsorted SET values
